...
// --- NOVÁ ČÁST: Řekneme serveru, ať ukazuje soubory ze složky 'public' ---
...
app.post('/login', async (req, res) => {
    // ... (zbytek kódu nech stejný, nebo zkopíruj ten funkční z minula) ...
    // Pro jistotu sem dávám celý funkční blok, abys to měl komplet:
    ...
    try {
        ...
        if(!outputHTML) return res.status(200).send("<p>Menu nenalezeno.</p>");
        res.send(outputHTML);
